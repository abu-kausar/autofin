  ...
  return (
    <div className='flex flex-col gap-[56px] py-[56px] mx-auto max-w-[720px]'>
      <div className='flex flex-col gap-3'>
        ...
        <h1 className='text-[48px] font-semibold text-[#101828]'>{blog.postName}</h1>
        ...
        <div className='flex items-center gap-2 mt-5'>
          ...
          <div className='flex flex-col gap-1'>
            <h2 className='text-lg font-semibold text-[#101828]'>{blog.author}</h2>
      ...
      <div className='flex flex-col'>
        <h1 className='text-[30px] font-semibold text-[#101828]'>Introduction</h1>
        ...
        <h1 className='text-[30px] font-semibold text-[#101828] mt-5 mb-[10px]'>Software and tools</h1>
        <p className='text-lg font-normal text-[#475467]'>Mi tincidunt elit, id quisque ligula ac diam, amet. Vel etiam suspendisse morbi eleifend faucibus eget vestibulum felis. Dictum quis montes, sit sit. Tellus aliquam enim urna, etiam. Mauris posuere vulputate arcu amet, vitae nisi, tellus tincidunt. At feugiat sapien varius id.
          Eget quis mi enim, leo lacinia pharetra, semper. Eget in volutpat mollis at volutpat lectus velit, sed auctor. Porttitor fames arcu quis fusce augue enim. Quis at habitant diam at. Suscipit tristique risus, at donec. In turpis vel et quam imperdiet. Ipsum molestie aliquet sodales id est ac volutpat.
        </p>

        <h1 className='text-[30px] font-semibold text-[#101828] mt-5 mb-[10px]'>Other resources</h1>
