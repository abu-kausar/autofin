...
const LoanCalculator = () => {
  ...
  return (
    <div className='absolute left-0 right-0 mx-auto transform translate-y-[50%] bottom-0 bg-white max-w-[1294px] flex items-center gap-5 rounded-[8px] custom-shadow'>
