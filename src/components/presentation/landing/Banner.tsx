...
const Banner = () => {
    return (
        <div className='mx-auto max-w-[1294px] mb-[98px] h-[400px] rounded-[24px] flex items-center bg-[url("/images/landing/banner.png")] bg-cover font-inter overflow-hidden'>
