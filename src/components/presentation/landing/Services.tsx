...
const Services = () => {
    return (
        <div className='mx-auto max-w-[1294px] flex items-center mb-[90px]'>
            <div className='w-1/2 flex flex-col gap-[50px]'>
                <div className='flex flex-col gap-3'>
                    <p className='text-lg font-normal text-bgBlack opacity-90'>SERVICES</p>
                ...
                <div className='flex gap-2'>
                    {
                        totalServices.map((service, idx) => (
                            <div key={idx} className='p-4 border border-[#9A57FE5C] hover:border-[#9A57FE] hover:shadow-[6px_21px_24.7px_0_rgba(154,87,254,0.19)] h-[230px] rounded-[22px] flex flex-col gap-3'>
