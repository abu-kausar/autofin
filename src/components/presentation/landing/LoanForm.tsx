      ...
      <form onSubmit={handleSubmit(onSubmit)} className='w-full flex-col gap-9'>
        <div className='flex gap-5'>
          <div className='w-1/2 flex flex-col gap-3'>
            <h3 className='text-base 2xl:text-xl font-medium text-bgBlack'>Vehicle Price <span className='text-[#98A2B3]'>(Out The Door Cost)</span></h3>
            <input {...register("price", { required: true })} placeholder="$10000" className='p-[10px_24px] 2xl:p-[10px_24px] outline-none focus:border-[#BB7AFE] text-base 2xl:text-xl font-normal text-bgBlack border border-[#D0D5DD] rounded-[54px] box-shadow: 0px 1px 2px 0px rgba(16, 24, 40, 0.05)' />
          </div>

          <div className='w-1/2 flex flex-col gap-3'>
            <h3 className='text-base 2xl:text-xl font-medium text-bgBlack'>Downpayment</h3>
            <input {...register("downpayment", { required: true })} placeholder="$3000" className='p-[10px_24px] 2xl:p-[10px_24px] outline-none focus:border-[#BB7AFE] text-base 2xl:text-xl font-normal text-bgBlack border border-[#D0D5DD] rounded-[54px] box-shadow: 0px 1px 2px 0px rgba(16, 24, 40, 0.05)' />
          </div>
        </div>

        <div className='flex mt-9 gap-5'>
          <div className='w-1/2 flex flex-col gap-3'>
            <h3 className='text-base 2xl:text-xl font-medium text-bgBlack'>Interest Rate <span className='text-[#98A2B3]'>(APR%)</span></h3>
            <input {...register("annualInterestRate", { required: true })} placeholder="4.99" className='p-[10px_24px] 2xl:p-[10px_24px] outline-none focus:border-[#BB7AFE] text-base 2xl:text-xl font-normal text-bgBlack border border-[#D0D5DD] rounded-[54px] box-shadow: 0px 1px 2px 0px rgba(16, 24, 40, 0.05)' />
          </div>

          <div className='w-1/2 flex flex-col gap-3'>
            <h3 className='text-base 2xl:text-xl font-medium text-bgBlack'>Loan Term</h3>
            <select
              {...register("loanTenureYears", { required: true })}
              className='p-[10px_24px] 2xl:p-[10px_24px] h-[50px] outline-none focus:border-[#BB7AFE] text-base 2xl:text-xl font-normal text-bgBlack border border-[#D0D5DD] rounded-[54px] select-arrow-padding select-with-placeholder'
              defaultValue=""
            >
